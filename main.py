...
def on_hover(event, frame, label):
    ...
    frame.place(x=button_x + button_width - 180, y=button_y + 80)
...
button1 = tk.Button(butt1Fr, textvariable=str2, width=25, height=5, cursor="hand2",
...
button2 = tk.Button(butt2Fr, textvariable=str3, width=25, height=5, cursor="hand2",
...
button3 = tk.Button(butt3Fr, textvariable=str4, width=25, height=5, cursor="hand2",
...
button4 = tk.Button(butt4Fr, textvariable=str5, width=25, height=5, cursor="hand2",
...
szumFrame.place(relx=0.25, rely=0, relheight=0.25)

open_button1 = tk.Button(frame1, textvariable=str6, width=12, command=lambda: choose_image(label1), cursor="hand2")
open_button1.pack(padx=10, pady=10)

open_button2 = tk.Button(szumFrame, textvariable=str7, width=18, command=lambda: add_noise(0, 50), cursor="hand2")
open_button2.pack(side=tk.LEFT, padx=10, pady=10)

open_button2_min_max = tk.Button(szumFrame, textvariable=str14, width=18, command=lambda: add_min_max(-50, 50), cursor="hand2")
open_button2_min_max.pack(side=tk.RIGHT ,padx=10, pady=10)

open_button3 = tk.Button(frame3, textvariable=str8, width=12, command=lambda: saveMultipleImg(cv2.imread("outputFolder/NoisyImg.jpg"), "SavedImages"), cursor="hand2")
...
hovFrame1 = tk.Frame(root, bg="#111110", width=200, height=200)
hovFrame2 = tk.Frame(root, bg="#111110", width=200, height=200)
hovFrame3 = tk.Frame(root, bg="#111110", width=200, height=200)
hovFrame4 = tk.Frame(root, bg="#111110", width=200, height=200)

hovLabel1 = tk.Label(hovFrame1, textvariable=str10, bg="#111110", fg="white", wraplength=180)
hovLabel2 = tk.Label(hovFrame2, textvariable=str11, bg="#111110", fg="white", wraplength=180)
hovLabel3 = tk.Label(hovFrame3, textvariable=str12, bg="#111110", fg="white", wraplength=180)
hovLabel4 = tk.Label(hovFrame4, textvariable=str13, bg="#111110", fg="white", wraplength=180)
